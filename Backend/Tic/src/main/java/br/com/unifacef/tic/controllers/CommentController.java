...
import br.com.unifacef.tic.services.CommentService;
...
public class CommentController {
	...
	public ResponseEntity<Page<Comment>> findAll(Pageable pageable){
		Page<Comment> list = service.findAllPaged(pageable);
	...
	@PostMapping
	public ResponseEntity<Comment> insert(@RequestBody Comment dto){
	...
	@PutMapping
	public ResponseEntity<Comment> update(@RequestBody Comment dto){
