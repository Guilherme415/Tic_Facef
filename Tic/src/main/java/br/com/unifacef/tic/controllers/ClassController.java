...
import br.com.unifacef.tic.services.ClassService;
...
public class ClassController {
	...
	public ResponseEntity<Page<Class>> findAll(Pageable pageable){
		Page<Class> list = service.findAllPaged(pageable);
	...
	@PostMapping
	public ResponseEntity<Class> insert(@RequestBody Class dto){
	...
	@PutMapping
	public ResponseEntity<Class> update(@RequestBody Class dto){
